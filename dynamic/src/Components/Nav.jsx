...
const Nav = () => {
  ...
  return (
    <nav className="navbar w-100 navbar-expand-md bg-body justify-content-around">
  <div className=" d-flex w-100 justify-content-between">
    ...
    <div class="collapse navbar-collapse justify-content-around" id="navcol-1" style={{marginLeft: 1, paddingLeft: 0}}>
      <input type="search" className="justify-content-center mx-auto" placeholder="search for a page" />
